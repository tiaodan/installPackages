...
const ip_sun = {
    ...
    //webscoket:'ws://dispIp:8090/webrtc',
    webscoket:'wss://dispIp:443/webrtc', 
    password:'123456', //功能配置密码，可修改
    coordinate:[
        {"city": "石家庄","maxZoom": 17,"minZoom": 4,"x": 114.53952,"y": 38.03647,"zoom":9},
        {"city": "北京","maxZoom": 18,"minZoom": 6, "x": 116.12,"y": 39.54,"zoom": 9},
...
const service_hd = {
    ...
    location:  {"city": "北京","maxZoom": 18,"minZoom":8, "x": 116.12,"y":  39.54,"zoom": 6}, //gis地图默认显示城市，可做修改
};

// 总的版本号
const version = "nms_login_show_version";
...
const service1 = {
    ...
    user: "/v1/nms-user-service",
    userCenter: "/v1/nms-user-service"
};
// 现场版
const service2 = {
    ...
    user: "/v1/eurekaUserServiceName",
    userCenter: "/v1/eurekaUserCenterServiceName",
    process: "/v1/eurekaNeServiceName" // 进程管理
};
...
const topic = {
    ...
    // 基站注册后选择数据信息
    btsRegister: "bts/register/replace",
    // bbu上报主题
